...
/**
 * @description device-specific bootloader code for YUYuphoria phones
 */
public class bootLoader_YUYuphoria extends bootLoader
{

    /**
     * For logging
     */
    private static final String TAG = "net.segv11.bootLoader_YUYuphoria";
    ...
    "dd ibs=1 count=1 skip=1048080 if=/dev/block/platform/soc.0/7824900.sdhci/by-name/aboot  # query ";
    private static final String writeCommand =
    "dd obs=1 count=1 seek=1048080 of=/dev/block/platform/soc.0/7824900.sdhci/by-name/aboot  # write ";

    private static final String queryTamperCommand =
    "dd ibs=1 count=1 skip=1048084 if=/dev/block/platform/soc.0/7824900.sdhci/by-name/aboot  # query ";
    private static final String writeTamperCommand =
    "dd obs=1 count=1 seek=1048084 of=/dev/block/platform/soc.0/7824900.sdhci/by-name/aboot  # write ";
