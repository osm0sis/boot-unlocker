...
/**
 * @description device-specific bootloader code for LenovoZukZ1 phones
 */
public class bootLoader_LenovoZukZ1 extends bootLoader
{
    /**
     * For logging
     */
	...
	"dd ibs=1 count=1 skip=2096656 if=/dev/block/platform/msm_sdcc.1/by-name/aboot  # query ";
    private static final String writeCommand =
	"dd obs=1 count=1 seek=2096656 of=/dev/block/platform/msm_sdcc.1/by-name/aboot  # write ";

    private static final String queryTamperCommand =
	"dd ibs=1 count=1 skip=2096660 if=/dev/block/platform/msm_sdcc.1/by-name/aboot  # query ";
    private static final String writeTamperCommand =
	"dd obs=1 count=1 seek=2096660 of=/dev/block/platform/msm_sdcc.1/by-name/aboot  # write ";
